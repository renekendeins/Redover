		...
		<div class="divLogin">
			<form method="post" action="php/access.php">
				<ul id='registryTable' style="list-style: none;text-align:center;" class="txt-center">
					<li><input id="signupUser" type="text" name="username" onchange="validateRegistry('0')" placeholder="Username"></li>
					<li><input id="signupMail" type="text" name="email" onchange="validateRegistry('0')" onchange="validateMail('signupMail')" placeholder="Email  (example@redover.com)"></li>
					<li><input id="password" type="password" name="password" onchange="validateRegistry('0')" placeholder="Password "></li>
					<li><input id="repeatPassword" type="password" name="verPassword" class="margin-bottom-20" onchange="validateRegistry('0')" placeholder="Repeat password"></li>
					<li style="max-width: 50%;margin: 0 auto;">
						<input type="submit" id="btn-registry" name="registry" disabled value="Access" style="cursor: pointer; width: 50%;float:left;margin-left: 5px;border: none;background-color: #3897f0;font-size: 17px;color: white;" onclick="validateRegistry('1')" >
				...
				<ul id='loginTable' style="list-style: none;text-align:center; display: none" class="txt-center">
					...
					<li><input id="password" type="password" name="password2" onchange="validateSignup('0')" placeholder="Password "></li>
