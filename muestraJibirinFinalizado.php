...
$insert = "SELECT Actu_Id, Actu_Pri, Actu_Tar, Actu_Desc, Actu_Ini, Actu_Fin, Actu_Est FROM actualizaciones WHERE Actu_EsT = 'Finalizado' ORDER BY Actu_Pri ASC";
...
$estado = $fila['Actu_Est'];
	...
	echo '	<td><input type="text" name="ide" value="'. $fila['Actu_Id'].'" style="display: none"><button type="submit" name="revisar" value="revisar" class="revisar">Revisar</button></form></td>';
